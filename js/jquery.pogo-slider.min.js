          ...
          h.prototype = {
                    ...
                    _onSliderReady: function () {
                              ...
                              if (j.settings.autoplay) {
                                        ...
                                        j.slideTimeRemaining =
                                                  j.slides[0].totalSlideDuration;
                                        j._slideTimeout(j.slideTimeRemaining);
                              }
                              if (
                                        j.settings.generateButtons &&
                                        j.slides.length > 1
                              ) {
                                        j._createDirButtons();
                              }
                              if (
                                        j.settings.generateNav &&
                                        j.slides.length > 1
                              ) {
                                        j._createNavigation();
                              }
                    ...
                    _createNavigation: function () {
                              ...
                              j.$element.addClass(
                                        "pogoSlider--nav" +
                                                  j.settings.navPosition
                              );
                              var l = d(
                                        '<ul class="pogoSlider-nav"></ul>'
                              ).appendTo(j.$element);
                    ...
                    _preserveTargetSize: function () {
                              ...
                              this.$element
                                        ...
                                        .each(function () {
                                                  var p = f.getComputedStyle(
                                                            this
                                                  );
                                                  var r = k.getAppliedProps(
                                                            this
                                                  );
                                                  var u = {};
                                                  if (
                              ...
                              if (this.settings.autoplay) {
                                        ...
                                        for (
                                                  ...
                                                  this.slides[
                                                            this
                                                                      .currentSlideIndex
                                                  ].children[j].$element.precss(
                                                            "animation-play-state",
                                                            "paused"
                                                  );
                                        }
                                        if (this.settings.onSliderPause) {
                                                  this.settings.onSliderPause.apply(
                                                            this
                                                  );
                                        }
                              }
                    ...
                    resume: function () {
                              if (this.settings.autoplay) {
                                        ...
                                        if (this.settings.onSliderResume) {
                                                  this.settings.onSliderResume.apply(
                                                            this
                                                  );
                                        }
                              }
                    ...
                    _changeSlide: function (m, o) {
                              ...
                              var k = n[j.slides[o].transition]
                                        ? j.slides[o].transition
                                        : "slide";
                    ...
                    _onSlideStart: function (k) {
                              ...
                              if (this.settings.autoplay) {
                                        this.slideStartTime = new Date();
                                        this.slideTimeRemaining = this.slides[
                                                  k
                                        ].totalSlideDuration;
                                        if (
                                                  this.settings
                    ...
                    _slideElementsTransitionIn: function (l) {
                              for (
                                        var j = 0;
                                        j < this.slides[l].children.length;
                                        j++
                              ) {
                    ...
                    _slideElementCleanup: function (m) {
                              ...
                              for (
                                        var k = 0;
                                        k < this.slides[m].children.length;
                                        k++
                              ) {
                    ...
                    _removeSlideSlices: function (l) {
                              ...
                              k.find(".pogoSlider-slide-slice")
                                        .not(":first")
                                        .remove();
                              k.find(".pogoSlider-slide-slice-inner")
                                        .children()
                                        .unwrap();
                              k.find(".pogoSlider-slide-slice")
                                        .children()
                    ...
                    slideTransitions: {
                              ...
                              verticalSplitReveal: function (l, n) {
                                        var k = this;
                                        var m = k.slides[n];
                                        k.slides[l].$element.css(
                                                  "z-index",
                                                  k.settings.baseZindex + 1
                                        );
                                        m.$element.css({
                                                  opacity: 1,
                                                  "z-index":
                              ...
                              blocksReveal: function (k, j) {
                                        ...
                                        u.slides[k].$element.css(
                                                  "z-index",
                                                  u.settings.baseZindex + 1
                                        );
                                        q.$element.css({
                                                  opacity: 1,
                                                  "z-index":
                              ...
                              foldRight: function (l, k) {
                                        ...
                                        var r = m.$element.find(
                                                  ".pogoSlider-slide-slice"
                                        );
                                        s._createSlideSlices(k, 1, 2);
                                        var o = s.slides[k].$element.find(
                                                  ".pogoSlider-slide-slice"
                                        );
                                        var n = r.eq(0);
                                        var p = o.eq(0);
                    ...
                    compatSlideTransitions: {
                              ...
                              zipReveal: function (n, p) {
                                        var m = this;
                                        var o = m.slides[p];
                                        m.slides[n].$element.css(
                                                  "z-index",
                                                  m.settings.baseZindex + 1
                                        );
                                        o.$element.css({
                                                  opacity: 1,
                                                  "z-index":
