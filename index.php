		...
		<nav class="navbar header-nav navbar-expand-lg">
			<div class="container">
				<a class="navbar-brand" href="index.php">
					<img src="imgs/sweet-wedding-white.png" width="120" height="60" title="sweet weeding" alt="sweet-wedding">
				</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="title-box">
							<h2>Odey Bobzee <span> & </span>Faith</h2>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="row align-items-center about-main-info">
							...
							<div class="col-lg-8 col-md-6 col-sm-12">
								<h2> <i class="fa fa-heart-o" aria-hidden="true"></i> <span>Faith</span> <i class="fa fa-heart-o" aria-hidden="true"></i></h2>
								<p>We did meet through a mutual friend at the end of my last year in college at Boki Health Science and Tecnology. We got along really well and clicked instantly. </p>
							</div>
						</div>
						<div class="row align-items-center about-main-info">
							<div class="col-lg-4 col-md-6 col-sm-12">
							...
							<div class="col-lg-8 col-md-6 col-sm-12">
								<h2> <i class="fa fa-heart-o" aria-hidden="true"></i> <span>Bobzee</span> <i class="fa fa-heart-o" aria-hidden="true"></i></h2>
								<p>We did meet through a mutual friend at the end of her last year in college at Boki Health Science and Tecnology. We got along really well and clicked instantly.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div id="story" class="story-box main-timeline-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Our Loves Stories</h2>
						<p>When you find the one person you can't live without. your soul mate thinks of you & only you. <br>When you are talking to each other, you say the same thing without knowing it.</p>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
						<div class="caption">
							...
							<div class="textContent">
								<p class="lead">I met my love faith when she was still a student and visited my company to make research of her project work.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
						<div class="caption">
							...
							<div class="textContent">
								<p class="lead">I took her to pack 50 a restuarant close to my organization.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
						<div class="caption">
							...
							<div class="textContent">
								<p class="lead">For 10 years of work as an engineer responsible about installing and maintenance computers for organization. follow by engagement story note</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-team-member">
						...
						<div class="family-info">
							<h4>Faith Family member name here</h4>
							<p>{ Faith’s Sister or Brother}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-team-member">
						<div class="family-img">
							<img class="img-fluid" src="imgs/medico.jpg" alt="" />
						</div>
						<div class="family-info">
							<h4>Medico Force</h4>
							<p>{ Bobzee Brother }</p>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-team-member">
						<div class="family-img">
							<img class="img-fluid" src="imgs/purity.jpg" alt="" />
						</div>
						<div class="family-info">
							<h4>Purity</h4>
							<p>{ Bobzee Niece}</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Friends</h2>
						<p>Bobzee Freinds and their photos below </p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-team-member">
						<div class="family-img">
							<img class="img-fluid" src="images/developer.jpg" alt="" />
						</div>
						<div class="family-info">
							<h4>Odu Marvelous Agobr: Software Engineer</h4>
							<p>{Bobzee Little Son (small Friend)}</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-team-member">
						<div class="family-img">
							<img class="img-fluid" src="imgs/friend.jpg" alt="" />
						</div>
						<div class="family-info">
							<h4>Friends Name</h4>
							<p>{ Bobzee Freind}</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Photography</h2>
						<p>Our Pictures Below enjoy the viewing</p>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="serviceBox">
						...
						<h4>03 December 2020 at 7:30 pm</h4>
						<p class="description">
							Party description below
						</p>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="serviceBox">
						...
						<h4>05 December 2020 at 9:30 pm</h4>
						<p class="description">
							Wedding description and venue below
						</p>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="serviceBox">
						...
						<h4>05 December 2020 at 3:30 pm</h4>
						<p class="description">
							Reception description and venue below
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Events</h2>
						<p>Events that will take place below</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
						...
						<h2>14 August 2020 Engagement</h2>
						<p>Engagement story here </p>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
						...
						<h2>05 Dec. 2020 Main Ceremony </h2>
						<p>Ceremony Story here</p>
						<a href="#">See location <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
						...
						<h2>05 Dec. 2020 Wedding party </h2>
						<p>Wedding Story here </p>
						<a href="#">See location <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						...
						<p>Send us good will messages and we hope to see you there!</p>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<div class="contact-block">
						<form action="index.php" method="post">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<select class="custom-select d-block form-control" required data-error="Please select an item in the list." name="guest">
								...
								<div class="col-md-6">
									<div class="form-group">
										<select class="custom-select d-block form-control" required data-error="Please select an item in the list." name="event">
								...
								<div class="col-md-12">
									...
									<div class="submit-button text-center">
										<button class="btn btn-common" type="submit" name="submit">Send Message</button>
